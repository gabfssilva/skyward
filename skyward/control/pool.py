...
from skyward.control.node.node import Node
...
if TYPE_CHECKING:
    from skyward.api.pool import FileOpKind, NodeSelection, NodeTarget
    from skyward.control.autoscaler import Autoscaler
    from skyward.control.instance_monitor import StreamMsg
...
class Pool:
    def __init__(
        ...
        *,
        ...
        self._log = logger.bind(component="pool")
