...
Example:
    ...
    from skyward.v2.stdout import stdout, is_head
...
if TYPE_CHECKING:
    from skyward.v2.runtime import PoolInfo
...
def stdout[**P, R](
    ...
    def decorator(fn: Callable[P, R]) -> Callable[P, R]:
        ...
        def wrapper(*args: P.args, **kwargs: P.kwargs) -> R:
            from skyward.v2.runtime import instance_info
...
def stderr[**P, R](
    ...
    Example:
        import skyward.v2 as sky
        from skyward.v2.stdout import stderr
