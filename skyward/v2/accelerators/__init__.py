...
Usage:
    ...
    # Direct import
    from skyward.v2.accelerators import H100, A100, T4
    h100 = H100(count=8)

    # Custom accelerator
    from skyward.v2.accelerators import Custom
...
# Re-export Literal types from v1 for type annotations
from skyward.accelerators.types import (
    AMD,
    GPU,
    NVIDIA,
    TPU,
