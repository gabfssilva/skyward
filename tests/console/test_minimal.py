...
from skyward.console.minimal import (
    _avg,
...
class TestHeader:
    ...
    def test_fractional_accelerator_count_preserved(self) -> None:
        from skyward.console.minimal import _fmt_count
...
class TestNodeTails:
    ...
    def test_tail_uses_instance_id_when_available(self) -> None:
        from skyward.console.minimal import _INSTANCE_ID_WIDTH
...
class TestResolveConsole:
    def test_true_maps_to_rich(self, monkeypatch: pytest.MonkeyPatch) -> None:
        from skyward.console import RichConsole, resolve_console
    ...
    def test_minimal_literal_maps_to_minimal(
        ...
        from skyward.console import MinimalConsole, resolve_console

        monkeypatch.setenv("SKYWARD_CONSOLE_FORCE_TTY", "1")
        assert resolve_console("minimal") is MinimalConsole

    def test_false_maps_to_none(self) -> None:
        from skyward.console import resolve_console
