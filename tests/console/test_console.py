...
class TestPhase:
    def test_phases_are_ordered(self) -> None:
        from skyward.console.state import _Phase
...
class TestThroughput:
    def test_throughput(self) -> None:
        from skyward.console.state import _State, _throughput
...
class TestBadge:
    def test_fixed_badge_has_style(self) -> None:
        from skyward.console.view import _badge_style
...
class TestEmit:
    def test_emit_prints_badge_and_text(self) -> None:
        from skyward.console.view import _emit
...
class TestFooter:
    def test_provisioning_footer_single_line(self) -> None:
        from skyward.console.state import _Phase, _State
        from skyward.console.view import _LiveFooter
    ...
    def test_bootstrap_footer_shows_progress(self) -> None:
        from skyward.console.state import _NodeStatus, _Phase, _State
        from skyward.console.view import _LiveFooter
...
class TestSummary:
    def test_summary_includes_duration(self) -> None:
        ...
        from skyward.console.view import _render_summary
...
class TestRichConsoleRenderer:
    def test_handles_local_output(self, monkeypatch) -> None:
        from skyward.console import LocalOutput
...
class TestFormatTask:
    def test_simple_function(self) -> None:
        from skyward.console.view import _format_task
...
class TestNodeLabel:
    def test_resolves_from_instances(self) -> None:
        ...
        from skyward.console.state import _State
        from skyward.console.view import _node_label
...
class TestInstanceIdResolution:
    def test_resolve_from_nodes_by_index(self) -> None:
        from skyward.console.state import _State
        from skyward.console.view import _resolve_instance_id
...
class TestSshUrl:
    def test_ssh_url_with_custom_port(self) -> None:
        ...
        from skyward.console.state import _State
        from skyward.console.view import _ssh_url
...
class TestNodeIdFromPath:
    def test_extracts_node_id(self) -> None:
        from skyward.console.view import _node_id_from_path
...
class TestCollectBadges:
    ...
    def _badges_plain(state: object) -> str:
        from skyward.console.view import _collect_badges
