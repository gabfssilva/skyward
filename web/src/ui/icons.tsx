export const ICON = {
  ...
  computes: '<rect x="3" y="4" width="18" height="7" rx="2"/><rect x="3" y="13" width="18" height="7" rx="2"/><path d="M7 7.5h.01M7 16.5h.01"/>',
  market: '<path d="M3 9l1.5-5h15L21 9"/><path d="M3 9v11h18V9"/><path d="M3 9a3 3 0 006 0 3 3 0 006 0 3 3 0 006 0"/>',
  providers: '<path d="M7 18a4.5 4.5 0 01-.6-8.96A7 7 0 0120 10.5a4 4 0 01-1 7.5H7z"/>',
  plus: '<path d="M12 5v14M5 12h14"/>',
  scale: '<path d="M4 20L20 4M4 20v-6M4 20h6M20 4v6M20 4h-6"/>',
