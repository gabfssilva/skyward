...
export type ComputeCreatedEvent = Schemas['ComputeCreated']
export type ComputeBoundEvent = Schemas['ComputeBound']
export type ComputeAdoptedEvent = Schemas['ComputeAdopted']
export type ComputeProvisioningEvent = Schemas['ComputeProvisioning']
export type ComputeReadyEvent = Schemas['ComputeReady']
export type ComputeDegradedEvent = Schemas['ComputeDegraded']
export type GenerationCreatedEvent = Schemas['GenerationCreated']
export type GenerationAppliedEvent = Schemas['GenerationApplied']
export type LeaseClaimedEvent = Schemas['LeaseClaimed']
export type LeaseReleasedEvent = Schemas['LeaseReleased']
export type ComputeAbandonedEvent = Schemas['ComputeAbandoned']
export type ComputeDeletingEvent = Schemas['ComputeDeleting']
export type ComputeDeletionFailedEvent = Schemas['ComputeDeletionFailed']
export type StraysTerminatedEvent = Schemas['StraysTerminated']
export type ComputeDeletedEvent = Schemas['ComputeDeleted']
export type CostEvent = Schemas['CostEvent']
export type NodeStateEvent = Schemas['NodeEvent']
export type ProgressEvent = Schemas['ProgressEvent']
export type ConsoleEvent = Schemas['ConsoleEvent']
export type PhaseEvent = Schemas['PhaseEvent']
export type MetricEvent = Schemas['MetricEvent']
export type TaskStateEvent = Schemas['TaskEvent']
