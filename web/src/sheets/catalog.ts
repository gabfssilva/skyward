/** The static vocabulary the wizard offers, ported from the prototype's data block. */
...
/** The class name a provider kind carries in the SDK, for the generated snippet. */
